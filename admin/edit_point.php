...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <form action=""  id="point_form" name="point_form" accept-charset="UTF-8" method='POST' name="tour_details_form" id="tour_details_form">
      ...
      <div class="form-group row">
        ...
        <div class=" col-5 custom-control custom-control-inline ">
          <!-- <input type="text"  id="point_average_time_minutes" name="point_average_time_minutes" class="form-control w-25 border"  onkeydown="return true" value="<?php echo $_SESSION["point"]["average_time_minutes"]; ?>" required > -->
      ...
      <div class="row justify-content-center mt-5">
        <button class="btn btn-primary btn-lg" id="bt" type="button" onclick="test()" style="width:250px;">Save changes</button>
      </div>
    </form>
      </div>
  </div>
  ...
  <script type="text/javascript">
    ...
    function test(){
      ...
      // console.log(category_id_selected);
