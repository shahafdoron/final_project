...
// להוסיף לשאילתה את היוזר ואת המדריך
      ...
      guided_tour.short_desc,(guided_tour.group_size-guided_tour.currently_participants) as remaining_tickets, guided_tour.registration_deadline,guided_tour.tour_cost
