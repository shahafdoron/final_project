...
<head>
  ...
  if(isset($_POST['enter'])){
    ...
    tour.is_acccessible_only=".$_SESSION['is_access']." and (guided_tour.group_size-guided_tour.currently_participants)>0 and guided_tour.registration_deadline > NOW()and guide.guide_id=user.user_id and user.user_type=2";
