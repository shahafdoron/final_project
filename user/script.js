...
function concatenateGuidedTours(json_data,user_type){
  ...
  // <button type='button' onclick='location.href='guided_info_book.php?tour="+JSON.stringify(json_data[i])+"'' class='btn btn-default btn-sm'><span class='glyphicon glyphicon-pencil'></span> Pencil </button>
  }
